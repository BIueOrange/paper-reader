...
- Save cropped figures as JPEG (quality 92) to `assets/`; use a distinct filename for tables such as `Table1.jpg`
- Record the asset path, crop confidence, source page, caption ID, and first-placement block in `source_map.json`
...
- Place each figure/table at its first substantive mention in the body text — not at the end
...
6. Source pointer: original caption ID and placement block ID
